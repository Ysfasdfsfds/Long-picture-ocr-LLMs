...
class LongImageOCR:
    ...
    def save_chat_analysis_result(self, chat_result: Dict, image_path: str) -> str:
        ...
        chat_result = deep_convert(chat_result)
    ...
    def save_json_result(self, merged_result: Dict, image_path: str) -> str:
        ...
        json_result = deep_convert(json_result)
    ...
    # _detect_green_content_box 方法已移至 refactor/remark_content.py
    
    # _detect_blue_content_box 方法已移至 refactor/remark_content.py
    
    # _calculate_box_iou 方法已移至 refactor/deduplication.py
    
    # _deduplicate_results 方法已移至 refactor/deduplication.py
    
    # _remark_content_with_deduplicated_data_wechat 方法已移至 refactor/remark_content.py


    # _remark_content_with_deduplicated_data_feishu 方法已移至 refactor/remark_content.py
    
    # _get_box_y_min 和 _get_box_center_y 方法已移至 refactor/remark_content.py
            
    # _mark_system_messages 方法已移至 refactor/remark_content.py

    # 以下方法已移至 refactor/remark_content.py:
    # _mark_time_content, _mark_nickname_and_content_with_avatars_wechat,
    # _mark_nickname_and_content_with_avatars_feishu, _mark_green_content,
    # _mark_adjacent_my_content, _is_adjacent_my_content, _is_between_avatars,
    # _get_box_x_min, _get_box_y_max, _get_avatar_y_min
    
    def _mark_nickname_and_content_with_avatars_wechat(self, ocr_results, avatars):
        """基于头像位置标记昵称和内容"""
    ...
    def _mark_nickname_and_content_with_avatars_feishu(self, ocr_results, avatars):
        """基于头像位置标记昵称和内容"""
    ...
    def _organize_chat_messages(self, marked_texts):
        ...
        while i < len(marked_texts):
            ...
            if "(系统消息)" in text:
                ...
                print(f"检测到系统消息: {system_content}")
            else:
                messages.append({
                    "type": "unknown",
                    "content": text
